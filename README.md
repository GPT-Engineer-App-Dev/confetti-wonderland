...
**Project**: confetti-wonderland 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a fun app where I can create confetti 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/confetti-wonderland.git
cd confetti-wonderland
npm i
